  ...
  z
    .object({
      ...
      surname: z
        .string()
        .regex(/^[А-ЯA-ZЁ]/, {
          message: 'surname should be start with upper-case latter',
        })
        .nonempty('field is empty')
        .min(1, { message: 'field length less than 1 latters' })
        .max(12, { message: 'field should be less than 12 latters' })
      ...
      fatherName: z
        .string()
        .regex(/^[А-ЯA-ZЁ]/, {
          message: 'fatherName should be start with upper-case latter',
        })
        .min(1, { message: 'field length less than 1 latters' })
        .max(20, { message: 'field should be less than 20 latters' })
        .refine((data) => !data.match(/[<>\/\\*&^%`\[\]{}()]/), {
          message: 'field shouldn`t contain symbols: [<>\/\\*&^%`\[\]{}()]',
        }),
      email: z
        ...
        .max(32, { message: 'field should be less than 32 latters' })
        .refine((data) => !data.match(/[<>\/\\*&^%`\[\]{}()]/), {
          message: 'field shouldn`t contain symbols: [<>\/\\*&^%`\[\]{}()]',
        }),
      phone: z.string(),
